        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <Button
              ...
              className="bg-white text-primary-700 rounded-r-xl rounded-l-none border-l-none border-black shadow-none border hover:bg-primary-700 hover:text-primary-50"
            >
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setLocalFilters((prev) => ({ ...prev, beds: value as string }))
              }
              items={{
                any: "Any beds",
                "1": "1+ bed",
          ...
          <div className="flex-1">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setLocalFilters((prev) => ({ ...prev, baths: value as string }))
              }
              items={{
                any: "Any baths",
                "1": "1+ bath",
